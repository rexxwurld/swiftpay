...
const payoutSchema = new mongoose.Schema(
  {
    ...
    // Hash of {amount, currency, destinationBankCode,
    // destinationAccountNumber, destinationAccountName} at the time this
    // payout was first requested. Lets requestPayout() detect the same
    // idempotencyKey being reused for a materially different request
    // (e.g. a different amount) instead of silently returning the
    // original payout (see audit report, High #17).
