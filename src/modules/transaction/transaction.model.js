...
const transactionSchema = new mongoose.Schema(
  {
    ...
    // invoice reconciliation) are no longer tracked via a flag on this
    // document - they're durable OutboxEvent documents created in the
    // SAME transaction as this Transaction (see
    // src/modules/outbox/outboxEvent.model.js and
    // transaction.service.js's recordIncomingPayment). Query OutboxEvent
    // by { sourceType: 'transaction', sourceRef: this._id } to see their
    // status instead.
