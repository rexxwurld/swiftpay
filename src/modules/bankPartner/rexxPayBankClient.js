...
// mirroring its POST submission endpoints, built the standard way this
// kind of provider-status-check call is done. The exact path/response
// shape below should be confirmed against RexxPay Bank's real API docs
// before depending on it in live mode - adjust the URL below if it
// differs.
