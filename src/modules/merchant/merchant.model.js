...
const merchantSchema = new mongoose.Schema(
  {
    ...
    // Updated (throttled, best-effort - see auth.middleware.js) on every
    // successful secret-key authentication. Lets a merchant/operator see
    // "is this key still being used anywhere" before rotating it - the
    // one piece of req. #22 (API key hygiene) this model didn't have
    // yet; hashing/rotation/mode-separation already existed.
